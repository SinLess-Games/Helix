...
class music(commands.Cog, description="The musical side of Helix"):
    ...
    @commands.command(name='cleanup', description="Cleans up the music player and Queue.")
    ...
    @commands.command(name='play', aliases=['sing', 'pl'], description="streams music")
    ...
    @commands.command(name='volume', aliases=['vol', 'v'], description="changes Helix's volume")
