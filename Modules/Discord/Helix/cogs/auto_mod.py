...
class AutoMod(commands.Cog):
    """
    The Moderation side, Work in progress
    """
    def __init__(self, bot):
        self.bot = bot

        self.conn = mysql.connector.connect(host='192.168.86.78', user='Admin', password='Shellshocker93!', database=f"discord")
    ...
    async def twitch(self, ctx, *, channel: discord.TextChannel = None):
        ...
        self.conn = mysql.connector.connect(host='192.168.86.78', user='Admin', password='Shellshocker93!',
                                            database=f"discord")
        self.c = self.conn.cursor()
