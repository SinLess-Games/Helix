...
class TicketCog(commands.Cog):
    ...
    async def create_ticket(self, ctx):
        ...
        message = await ctx.send(
            'React to this message with ' + data["ticket-emoji"] + ' to open a private chat with the support team')
            ...
            if not data["bot-role"] in [y.name.lower() for y in payload.member.roles]:
                if payload.emoji.name == data["ticket-emoji"]:
                    ...
                    em = discord.Embed(
                        ...
                        color=0x00a8ff)
                    em.add_field(name="Don't worry",
                                 value="You will get help in a short time " + payload.member.mention)
