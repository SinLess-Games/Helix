...
public class Invoice implements Serializable {
    ...
    private PaymentMethod paymenMethod;
    ...
    public Invoice paymenMethod(PaymentMethod paymenMethod) {
        this.setPaymenMethod(paymenMethod);
        return this;
    }

    public void setPaymenMethod(PaymentMethod paymenMethod) {
