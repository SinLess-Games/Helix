...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/invoice/api/customers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new customer")
            .post("/services/invoice/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                ...
                , "email":"SAMPLE_TEXT"
                , "phone":"SAMPLE_TEXT"
                , "adressLine1":"SAMPLE_TEXT"
                , "adressLine2":"SAMPLE_TEXT"
                , "city":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/invoice${new_customer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created customer")
            .delete("/services/invoice${new_customer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
