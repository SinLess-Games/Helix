...
import com.sinlessgamesllc.domain.Invoice;
import com.sinlessgamesllc.domain.ProductOrder;
import com.sinlessgamesllc.domain.enumeration.InvoiceStatus;
import com.sinlessgamesllc.domain.enumeration.PaymentMethod;
import com.sinlessgamesllc.repository.InvoiceRepository;
...
class InvoiceResourceIT {
    ...
    private static final PaymentMethod DEFAULT_PAYMEN_METHOD = PaymentMethod.Credit_Card;
    private static final PaymentMethod UPDATED_PAYMEN_METHOD = PaymentMethod.Bank;
    ...
    public static Invoice createEntity(EntityManager em) {
        Invoice invoice = new Invoice()
            ...
            .paymenMethod(DEFAULT_PAYMEN_METHOD)
    ...
    public static Invoice createUpdatedEntity(EntityManager em) {
        Invoice invoice = new Invoice()
            ...
            .paymenMethod(UPDATED_PAYMEN_METHOD)
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getPaymenMethod()).isEqualTo(DEFAULT_PAYMEN_METHOD);
    ...
    @Test
    @Transactional
    void checkPaymenMethodIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceRepository.findAll().size();
        // set the field null
        invoice.setPaymenMethod(null);
    ...
    void getAllInvoices() throws Exception {
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.[*].paymenMethod").value(hasItem(DEFAULT_PAYMEN_METHOD.toString())))
    ...
    void getInvoice() throws Exception {
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.paymenMethod").value(DEFAULT_PAYMEN_METHOD.toString()))
    ...
    void putNewInvoice() throws Exception {
        ...
        assertThat(testInvoice.getPaymenMethod()).isEqualTo(UPDATED_PAYMEN_METHOD);
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.status(UPDATED_STATUS).paymenMethod(UPDATED_PAYMEN_METHOD).paymentDate(UPDATED_PAYMENT_DATE);
