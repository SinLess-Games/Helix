...
import com.sinlessgamesllc.domain.Product;
import com.sinlessgamesllc.domain.enumeration.Size;
import com.sinlessgamesllc.domain.enumeration.Type;
import com.sinlessgamesllc.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final Type DEFAULT_TYPE = Type.Digital;
    private static final Type UPDATED_TYPE = Type.Physical;
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.type(UPDATED_TYPE).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
