...
@RestController
@RequestMapping("/api/helix-kafka")
public class HelixKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HelixKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HelixKafkaResource(KafkaProperties kafkaProperties) {
