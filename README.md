# 
# ![Alt Text](https://github.com/SinLess-Games/Helix/blob/9048d67d423b6cffcb2bd37be51a1a50d1ac16c6/Documentation/img/Untitled.png)  
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/PL_Banner.png)
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/SL_Banner.png)   
**Supported Languages**  
- English  
- More in the future...  
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/Integrations_Banner.png)  
**Integrations**  
- Google
  - calender
  - search engine
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/WICD_Banner.png)  
**What it can do**
- Open apps
  - MODULE CUSTOM
- Open URLs
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/TECH_Banner.png)  
**Technologies**
  - Speech Recognition
  - Speech Synthesis
  - nueral network
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/UI_Banner.png)  
**USER INTERFACE**
- WEBBASED GUI
  - Helix Setting
  - Discord Settings
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/Packager_Banner.png)  
**Packager**
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/OS_Support_Banner.png)  
**Os Support**
- windows
- (future) linux
- (possibility) MAC
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/DevNotes_Banner.png)   
**DEV NOTES**
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/Credits_Banner.png)  
**CREDITS**
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/Useful_Banner.png)  
**Useful Info**
...
# 
# ![Alt Text](https://github.com/Sinless-Gaming-and-programming/HELIX/blob/0.1/Documentation/img/Seeking_Banner.png) 
