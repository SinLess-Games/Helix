...
In the digital age, cyber attacks are inevitable. At SinLess Games, we are taking a
...
(a) SinLess Games's security program and operations should be designed and
...
(b) Security shall remain a top priority in all aspects of SinLess Games's business
...
### SinLess Games Security Principles
...
SinLess Games security operations take the approach that assumes a compromise can
...
The SinLess Games platform leverages a micro-service architecture. This means that
...
where the change will be available to SinLess Games customers and end-users.
...
It is of the utmost importance that SinLess Games provides for confidentiality (privacy), integrity
...
SinLess Games platform and services.
...
Additionally, SinLess Games security team will actively monitor threat intelligence
...
As much as possible, SinLess Games security will translate policy and compliance
...
the development process, SinLess Games security team makes security standards and
...
SinLess Games developed a security architecture on top of its three main
...
* SinLess Games services deployed inside private subnets of Virtual Private Cloud (VPC)
...
SinLess Games strives to leverage functions as the primary building
...
to key metrics of the SinLess Games information security program, to
...
SinLess Games strives to provide a high quality of service
to all of its customers. This is accomplished through a security
architecture that encompasses all of SinLess Games's operations
and provides high data confidentiality, integrity, and availability.

An overview of SinLess Games's architecture can be found in
[Security Architecture](cp-model-architecture.md).
SinLess Games uses a highly scalable cloud architecture to
...
SinLess Games uses DevOps methodology as described in
