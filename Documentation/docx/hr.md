...
SinLess Games is committed to ensuring all workforce members actively address
security and compliance in their roles at SinLess Games. We encourage self management
...
SinLess Games policy requires all workforce members to comply with the
...
the environments, systems, security requirements, and procedures SinLess Games has in
...
SinLess Games systems has been removed, as well as ensuring that all company owned
assets are returned.

(e) SinLess Games and its employees will take reasonable measures to
ensure no sensitive data is transmitted via digital communications such as email
or posted on social media outlets.

(f) SinLess Games will maintain a list of prohibited activities that will be part of
...
business contracts, etc. SinLess Games reserves the right to terminate employees in
...
SinLess Games uses  to manage its workforce personnel records.
...
SinLess Games requires all workforce members to comply with the following
acceptable use requirements and procedures, such that:

(a) Per SinLess Games [security architecture](model.md), all workforce
...
(k) Mobile devices are not allowed to connect directly to SinLess Games production
environments.


### Employee Screening Procedures

SinLess Games publishes job descriptions for available positions and
...
[SinLess Games's internal file sharing site](#).
...
1. Training.
    ...
    * New workforce member is provided training on SinLess Games security policy,
...
2. Access.
    ...
    * Non-standard access requires additional approval following the access
      request procedures.
    * Request for modifications of access for any SinLess Games employee
...
3. Security will terminate users' access rights immediately upon notification,
   and will coordinate with the appropriate SinLess Games employees to terminate
...
SinLess Games workforce members are to escalate issues using the
...
SinLess Games's incident response procedures; if you are unsure whether
...
The SinLess Games requires all workforce members to observe high
...
to report serious concerns so that SinLess Games can address and correct
...
SinLess Games encourages employees to go above and beyond to contribute
...
SinLess Games provides employees the opportunity to attend conferences,
...
Workforce members shall report non-compliance of SinLess Games's policies and
...
1. The Security Officer promptly facilitates a thorough investigation of all
   reported violations of SinLess Games's security policies and procedures. The
    ...
    * Provide individuals suspected of non-compliance of the Security rule
      and/or SinLess Games's policies and procedures the opportunity to explain their
      actions.
...
2. Violation of any security policy or procedure by workforce members may result
    ...
    * SinLess Games reserves the right to terminate employees in the case of serious
      cases of misconduct.
    * A violation resulting in a breach of confidentiality (i.e. release of
      ...
      termination of the workforce member from SinLess Games.
...
4. In the case of an insider threat, the Security Officer and Privacy Officer
   ...
   malicious activity. SinLess Games workforce members are encouraged to come forward
