...
* *Application*: An application hosted by SinLess Games, either maintained and
  created by SinLess Games, or maintained and created by a Customer or Partner.

* *Application Level*: Controls and security associated with an Application. In
  the case of PaaS Customers, SinLess Games does not have access to and cannot assure
...
* *Backup Service*: A logging service for unifying system and application logs,
  encrypting them, and providing a dashboard for them. Offered with all SinLess Games
...
* *Disaster Recovery Service*: A disaster recovery service for disaster recovery
  ...
  an outage. Offered with all SinLess Games Add-ons and as an option for PaaS
  Customers.
...
* *Customers*: Contractually bound users of SinLess Games Platform and/or services.
...
* *Event*: An event is defined as an occurrence that does not constitute a
  serious adverse effect on SinLess Games, its operations, or its Customers, though
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification
  to customers in the case of suspicious activity. Offered with all SinLess Games
  Add-ons and as an option for PaaS Customers.
...
* *Partner*: Contractual bound 3rd party vendor with integration with the
  SinLess Games Platform. May offer Add-on services.

* *PMP or Platform*: SinLess Games Precision Medicine Platform and its overall
...
* *Security Incident* (or just Incident): A security incident is an occurrence
  ...
  * Unauthorized change or destruction of sensitive data (i.e. deletion or
    alterations not following SinLess Games's procedures);
...
* *Vendor*: External individuals or organizations marketing or selling products
  or services, or providing services to SinLess Games.
...
Software approved for use at SinLess Games includes, but is not limited to:
...
processing information (as defined in our [Privacy Policy](https://sinlessgames.com/cookie-policy))
...
[Privacy Policy](https://sinlessgames.com/cookie-policy), primarily to remember things about you
...
**Service Features and Performance** | To provide you with functionality and optimize the performance of the Services. For example, to allow you to share information from SinLess Games mobile apps with friends within your social networks/circles.
...
SinLess Games websites and our Services do not respond to Do Not Track
...
contact us at privacy@sinlessgames.com.
...
**PAYMENT AND CARD INFORMATION.** Some SinLess Games Services
...
## SinLess Games HIPAA Business Associate Agreement ("BAA")
...
between SinLess Games LLC ("Company") and the Supplier named on the signature page
...
## HIPAA Mappings to SinLess Games Policies and Controls
...
## NIST Mappings to SinLess Games Policies and Controls
