...
SinLess Games implements an information security incident response process to
...
the policies and procedures specified in the following SinLess Games policies and
procedures:
...
Current members of the SinLess Games SIRT:
...
The SinLess Games incident response process follows the process recommended by
...
SinLess Games's incident response classifies security-related events into the
...
* **Precursors** - A sign that an incident may occur in the future. Examples:
    ...
    * Suspicious emails targeting specific SinLess Games staff members with
...
SinLess Games employees must report any unauthorized or suspicious activity seen on
...
1. Immediately upon observation SinLess Games members report suspected and known
   Events, Precursors, Indications, and Incidents in one of the following ways:
    ...
    4. Submit an incident report online via
       [SinLess Games Internal ServiceDesk]();
    5. Secure chat; or
...
3. The Security Officer, Privacy Officer, or SinLess Games representative appointed
...
4. In the case of a threat identified, the Security Officer is to form a team to
   investigate and involve necessary resources, both internal to SinLess Games and
   potentially external.

#### II - Containment (Technical)

In this Phase, SinLess Games's engineers and security team attempts to contain the
...
2. A "lessons learned" section is written and attached to Incident ticket.
    ...
    1. Evaluate the cost and impact of the security incident to SinLess Games using
...
3. Ensure all incident related information is recorded and retained as described
   in SinLess Games Auditing requirements and Data Retention standards.
...
SinLess Games's expectation for them, relative to security responsibilities. The
...
Entity to which SinLess Games is a Business Associate of, the IRT and management team
...
that impacts production systems – SinLess Games plans to operate in a “read-only”
...
At least once per year, SinLess Games security and engineering teams
