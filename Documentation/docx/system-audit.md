...
SinLess Games shall audit, monitor, and assess the access and activity of
...
capabilities and resources. SinLess Games shall make reasonable and
...
It is the policy of SinLess Games to safeguard the confidentiality, integrity, and
availability of applications, systems, and networks. To ensure that appropriate
safeguards are in place and effective, SinLess Games shall audit access and activity
...
This policy applies to all SinLess Games systems that store, transmit, or process
...
(c) An annual audit of SinLess Games security controls must be conducted, either by a
...
SinLess Games's auditing processes include the following.
...
2. **Access Review:** This refers to the review of all user and service accounts
   and permissions across SinLess Games operational environments, including
    ...
    * SinLess Games developed an internal tool to automatically pull configurations
...
3. **Compliance and Controls Audit:** This refers to the audit performed against
   ...
   SinLess Games policies and procedures, to measure their adoption and
...
* Responsibility for audit activity is assigned to SinLess Games's Security Officer.
  The Security Officer shall:
    ...
    * All connections to SinLess Games are monitored. Access is limited to certain
...
3. A request for an audit must be reviewed and approved by SinLess Games's Privacy
    ...
    * Should the audit disclose that a workforce member has accessed sensitive data
      ...
      be shared with SinLess Games's Security Officer to determine appropriate
    ...
    * Only de-identified information shall be shared with Customer or Partner
      ...
      will be communicated to the appropriate personnel by SinLess Games's Privacy
      Officer or designee. Prior to communicating with customers and partners
      regarding an audit, it is recommended that SinLess Games consider seeking
...
2. The reporting process shall allow for meaningful communication of the audit
    ...
    * Significant findings shall be reported immediately in a written format.
      SinLess Games's security incident response form may be utilized to report a
      single event.
...
4. Security audits constitute an internal, confidential monitoring practice that
   may be included in SinLess Games's performance improvement activities and
...
SinLess Games logging standards requires application and system logs to contain
...
All systems and software developed at SinLess Games must have the following security
...
5. All SinLess Games IT infrastructure must have system clock synchronized
...
3. Whenever possible, audit logs shall be stored on a separate system to
    ...
    * SinLess Games logging servers may include Elasticsearch, Logstash, and Kibana
...
1. Periodic monitoring of Customer and Partner activity shall be carried out to
   ...
   necessary to the arrangement between SinLess Games and the 3rd party.
   SinLess Games will make every effort to assure Customers and Partners
...
1. If it is determined that the Customer or Partner has exceeded the scope of
   access privileges, SinLess Games's management and security must remedy
...
1. If it is determined that a Customer or Partner has violated the terms of the
   ...
   SinLess Games must take immediate action to remediate the situation. Continued
   violations may result in discontinuation of the business relationship.


### Auditing and Assessment Tools

SinLess Games's Security Officer is authorized to select and use assessment tools
that are designed to detect vulnerabilities and intrusions. Use of such tools
against SinLess Games systems and environments are prohibited by others, including
...
1. SinLess Games workforce members are provided training, education, and
   awareness on safeguarding the privacy and security of business and data.
   SinLess Games's commitment to auditing access and activity of the
   ...
   applicable policies. SinLess Games workforce members are made aware of
...
2. SinLess Games Customers are provided with necessary information to understand
   SinLess Games auditing capabilities. Platform Customers are responsible for the
   logging, auditing and retention of any application hosted outside of SinLess Games
   environments, even though the applications may integrate with SinLess Games
   Platform API.  Customer applications hosted within the SinLess Games environments
