...
Security and compliance is everyone's responsibility.  SinLess Games is committed to
...
managers and executives at SinLess Games.
...
oversight of all activities pertaining to SinLess Games's efforts to be compliant
...
SinLess Games has appointed Timothy Pierce as the Security
Officer and Timothy Pierce as the Privacy Officer.
...
workforce members are required to:
  ...
  * Follow all security requirements set forth in SinLess Games security
...
(c) All workforce members are required to report non-compliance of SinLess Games's
...
the select members of the senior leadership team, including CEO COO CTO CSO CPO,
in addition to the Security and Privacy Officer.

#### General Responsibilities of the Security and Privacy Officer

The authority and accountability for SinLess Games’s information
...
workforce members and any other user of SinLess Games's systems, applications,
...
3. Take all reasonable steps to hire, retain, and promote workforce members and
   ...
   SinLess Games's security policies and procedures.

#### Segregation of Duties

SinLess Games has dedicated team/personnel assigned the job
...
3. The training session focuses on, but is not limited to, the following
   subjects defined in SinLess Games's security policies and procedures:

    1. SOC 2 Security Principals and Controls;
    1. HIPAA Privacy, Security, and Breach notification rules;
    1. Risk Management procedures and documentation;
    1. Auditing. SinLess Games may monitor access and activities of all users;
    1. Workstations may only be used to perform assigned job responsibilities;
    1. Users may not download software onto SinLess Games's workstations
    ...
    of SinLess Games's systems and/or workstations;
    ...
    do so by a SinLess Games Customer;
    1. Users are required to understand their role in SinLess Games's contingency
    plan;
...
SinLess Games leverages KnowBe4 to deliver innovative, fun and
...
SinLess Games requires all employees to take a HIPAA awareness training
...
SinLess Games holds a company-wide roundtable at least quarterly to
