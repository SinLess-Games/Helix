...
In the case of a breach, SinLess Games shall notify all affected
...
SinLess Games must report the breach to individuals impacted following
...
1. Discovery of Breach: A data breach shall be treated as "discovered" as of
   ...
   exercising reasonable diligence would have been known to SinLess Games
   (includes breaches by the organization's Customers, Partners, or
   subcontractors). SinLess Games shall be deemed to have knowledge of a
   ...
   process to notify each Customer affected by the breach. SinLess Games
...
1. Breach Investigation: The SinLess Games Security Officer shall name an
...
1. Risk Assessment: A risk assessment is performed in accordance to applicable
    ...
    * The cause of the breach, and the entity responsible for the breach, either
      Customer, SinLess Games, or Partner.
...
1. Timeliness of Notification: Upon discovery of a breach, notice shall be made
   to the affected SinLess Games Customers, usually within 24-48 hours
...
1. Content of the Notice: The notice shall be written in plain language and must
    ...
    * A brief description of what SinLess Games is doing to investigate
...
1. Methods of Notification: SinLess Games Customers will be notified via
...
1. Maintenance of Breach Information/Log: As described above and in addition to
   the reports created for each incident, SinLess Games shall maintain a
...
1. Workforce Training: SinLess Games shall train all members of its
...
1. Complaints: SinLess Games must provide a process for individuals to
...
1. Retaliation/Waiver: SinLess Games may not intimidate, threaten, coerce,
...
### SinLess Games Platform Customer Responsibilities

The following requirements and guidelines shall be provided to and agreed upon
by a client organization using SinLess Games platform to host sensitive
data such as ePHI and PII.

The agreement may be in the form of a contract or acceptance of terms and
conditions.

1. The SinLess Games Customer that accesses, maintains, retains,
   ...
   later than 72 hours after discovery of a breach, notify SinLess Games
   of such breach. The Customer shall provide SinLess Games with the
...
1. Depending on the nature of the breach, an investigation may be conducted by
   SinLess Games or the Customer or jointly to determine the cause of breach.

1. Notice to Media: Unless SinLess Games is directly at fault for the
   cause of breach, SinLess Games Customers are responsible for providing
   notice to prominent media outlets at the Customer's discretion.

1. Notice to Authorities: Unless SinLess Games is directly at fault for
   the cause of breach, SinLess Games Customers are responsible for
...
I am writing to you from SinLess Games LLC, with important information about
...
* A brief description of what SinLess Games is doing to investigate the
